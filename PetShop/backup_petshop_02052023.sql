...
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela petshop.auditoria: ~2 rows (aproximadamente)
/*!40000 ALTER TABLE `auditoria` DISABLE KEYS */;
INSERT INTO `auditoria` (`codAuditoria`, `acao`, `tabela`, `dataHora`, `usuario`) VALUES
	(12, 'Cliente Inserido: Leonardo Paiva', 'cliente', '2023-05-02 10:02:23', 'root@localhost'),
	(13, 'Cliente [10] Removido: Leonardo Paiva', 'cliente', '2023-05-02 10:14:04', 'root@localhost'),
	(14, 'Cliente Inserido: Gustavo Alves', 'cliente', '2023-05-02 10:20:26', 'root@localhost'),
	(15, 'CPF Alterado - Cliente[11]', 'cliente', '2023-05-02 10:20:59', 'root@localhost');
...
INSERT INTO `cliente` (`codCliente`, `nomeCliente`, `enderecoCliente`, `bairroCliente`, `cidadeCliente`, `cepCliente`, `ufCliente`, `dataNascimento`, `cpfCliente`, `emailCliente`, `telefoneCliente`) VALUES
	...
	(11, 'Gustavo Alves', 'Centro', 'Centro', 'Machado', '37.750-000', 'MG', '2003-05-02', '132.132.113-12', 'gustavo@gmail.com', '(35)99822-3030');
...
DROP TRIGGER IF EXISTS `tri_LogAlteraCPF`;
