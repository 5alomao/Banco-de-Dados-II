...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='Registra as principais alterações neste BD.';

-- Copiando dados para a tabela lanchonete3si_2023.auditoria: ~4 rows (aproximadamente)
/*!40000 ALTER TABLE `auditoria` DISABLE KEYS */;
INSERT INTO `auditoria` (`codAuditoria`, `acao`, `tabela`, `dataHora`, `usuario`) VALUES
	(1, 'Produto [Empada de Palmito] vendido. Quantidade [3]. Para a venda [4]', 'itemvenda', '2023-05-11 10:40:42', 'root@localhost'),
	(2, 'Produto [Empada de Palmito] devolvido para o Estoque. Quantidade [5]. Pela venda [1]', 'itemvenda', '2023-05-11 10:49:55', 'root@localhost'),
	(4, 'Produto [Empada de Palmito] vendido. Quantidade [2]. Para a venda [5]', 'itemvenda', '2023-05-16 09:58:12', 'root@localhost'),
	(5, 'Produto [Empada de Palmito] devolvido para o Estoque. Quantidade [2]. Pela venda [5]', 'itemvenda', '2023-05-16 10:02:52', 'root@localhost');
...
-- Copiando dados para a tabela lanchonete3si_2023.itemvenda: ~1 rows (aproximadamente)
...
INSERT INTO `produto` (`codProduto`, `nome`, `precoCusto`, `precoVenda`, `margemLucro`, `dataValidade`, `quantidadeEstoque`, `quantidadeMinima`, `CATEGORIA_codCategoria`, `MARCA_codMarca`) VALUES
	(1, 'Empada de Palmito', 1.80, 2.16, 20.00, '2022-11-20', 23.00, 10.00, 1, 6),
	(2, 'Prestígio', 2.00, 2.50, 25.00, '2022-12-11', 50.00, 15.00, 6, 1),
	(3, 'Guaraná 600ml', 2.00, 2.60, 30.00, '2023-05-21', 45.00, 20.00, 4, 5),
	(4, 'Serenata de Amor', 1.50, 3.00, 100.00, '2023-09-30', 40.00, 10.00, 6, 2);
...
INSERT INTO `venda` (`codVenda`, `dataHora`, `desconto`, `tipoVenda`, `CLIENTE_codCliente`) VALUES
	...
	(4, '2023-05-11 10:14:14', NULL, 'PIX', 1),
	(5, '2023-05-16 09:56:22', NULL, 'Cartão Débito', 2);
